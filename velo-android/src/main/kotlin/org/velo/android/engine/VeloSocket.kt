...
/**
 * Host implementation of the Velo `Socket` native (registered under the name
 * `Socket`). Copied from the CLI's `Socket` — it already uses only `java.net`,
 * which is available on Android. Requires the `INTERNET` permission.
 */
class VeloSocket {
